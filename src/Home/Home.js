...
class Home extends React.Component {
  ...
  componentDidMount() {
    ...
    axios.get(this.state.api + "api/gainersLosers.php").then(res => {
      this.setState(
        {
            ...
            <div className="col-md-6">
              <Card className="mt-4 shadow-sm text-center">
                <Card.Body>
                  ...
                  <p>
                    Learn how to find cheap and great companies using the proven
                    methods of great investors.
                    <div className="mt-3">
                      <a
                        className="btn btn-outline-success"
                        href="https://howtoinvestforbeginners.com/"
                      >
                        Learn how
                      </a>
                    </div>
